...
**7.** Compare the substitution risk in this group (G29, teacher's first teaching displaced by app instruction) with the substitution risk in Chapter 27's group (G26, scaffolding without fading). Both have high-to-medium substitution risk. What is structurally different about *what* is being substituted in each — and why does the minute-audit catch this chapter's failure while the two-line graph catches Chapter 27's? *(Difficulty: high. Tests: cross-chapter synthesis that identifies the different substitution casualty in each group and the evidence instrument designed to catch it.)*
